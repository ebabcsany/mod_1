package net.minecraft.item.texture;
...
public class Stitcher {
   ...
   private static final Comparator<Holder> COMPARATOR_HOLDER = Comparator.<Holder, Integer>comparing((p_217793_0_) -> {
   ...
   private final Set<Holder> setStitchHolders = Sets.newHashSetWithExpectedSize(8192);
   private final List<Slot> stitchSlots = Lists.newArrayListWithCapacity(8192);
   ...
   public void doStitch() {
      List<Holder> list = Lists.newArrayList(this.setStitchHolders);
   ...
   public void getStitchSlots(ISpriteLoader spriteLoaderIn) {
      for(Slot stitcher$slot : this.stitchSlots) {
         stitcher$slot.getAllStitchSlots((p_229210_2_) -> {
            Holder stitcher$holder = p_229210_2_.getStitchHolder();
