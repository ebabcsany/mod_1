...
public abstract class MobEntity extends LivingEntity {
   ...
   protected MobEntity(EntityType<? extends MobEntity> type, World worldIn) {
      super(type, worldIn);
      this.goalSelector = new GoalSelector(worldIn.func_234924_Y_());
      this.targetSelector = new GoalSelector(worldIn.func_234924_Y_());
   ...
   public boolean func_233660_b_(PathNodeType p_233660_1_) {
      return p_233660_1_ != PathNodeType.DANGER_FIRE && p_233660_1_ != PathNodeType.DANGER_CACTUS && p_233660_1_ != PathNodeType.DANGER_OTHER;
   }
   ...
   public boolean func_233659_b_(ItemStack p_233659_1_, ItemStack p_233659_2_) {
      if (p_233659_1_.getDamage() >= p_233659_2_.getDamage() && (!p_233659_1_.hasTag() || p_233659_2_.hasTag())) {
         if (p_233659_1_.hasTag() && p_233659_2_.hasTag()) {
            return p_233659_1_.getTag().keySet().stream().anyMatch((p_233664_0_) -> {
               return !p_233664_0_.equals("Damage");
            }) && !p_233659_2_.getTag().keySet().stream().anyMatch((p_233662_0_) -> {
      ...
      if (itemstack.getItem() == Items.LEAD && this.canBeLeashedTo(p_233661_1_)) {
         ...
         if (itemstack.getItem() instanceof SpawnEggItem) {
            if (!this.world.isRemote) {
               ...
               Optional<MobEntity> optional = spawneggitem.func_234809_a_(p_233661_1_, this, (EntityType)this.getType(), this.world, this.getPositionVec(), itemstack);
               optional.ifPresent((p_233658_2_) -> {
                  this.onChildSpawnFromEgg(p_233661_1_, p_233658_2_);
               });
   ...
   protected SrechEntityActionResultType drurn_action(PlayerEntity p_230254_1_, Hand p_230254_2_) {
      return SrechEntityActionResultType.PASS;
   }
   ...
   @Nullable
   protected <T extends MobEntity> T func_233656_b_(EntityType<T> p_233656_1_) {
      if (this.removed) {
         return (T)null;
      } else {
