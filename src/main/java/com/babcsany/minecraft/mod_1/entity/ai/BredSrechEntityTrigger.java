...
public class BredSrechEntityTrigger extends AbstractCriterionTrigger<BredSrechEntityTrigger.Instance> {
   private static final ResourceLocation ID = new ResourceLocation("bred_srech_entity");

   public ResourceLocation getId() {
      return ID;
   }

   public BredSrechEntityTrigger.Instance deserializeTrigger(JsonObject json, EntityPredicate.AndPredicate entityPredicate, ConditionArrayParser conditionsParser) {
      ...
      return new BredSrechEntityTrigger.Instance(entityPredicate, entitypredicate$andpredicate, entitypredicate$andpredicate1, entitypredicate$andpredicate2);
   }

   public void trigger(ServerPlayerEntity player, AbstractSrechEntity parent1, AbstractSrechEntity parent2, @Nullable AgeableEntity child) {
   ...
   public static class Instance extends CriterionInstance {
      ...
      public Instance(EntityPredicate.AndPredicate player, EntityPredicate.AndPredicate parent, EntityPredicate.AndPredicate partner, EntityPredicate.AndPredicate child) {
         super(BredSrechEntityTrigger.ID, player);
         this.parent = parent;
         this.partner = partner;
         this.child = child;
      }

      public static BredSrechEntityTrigger.Instance any() {
         return new BredSrechEntityTrigger.Instance(EntityPredicate.AndPredicate.ANY_AND, EntityPredicate.AndPredicate.ANY_AND, EntityPredicate.AndPredicate.ANY_AND, EntityPredicate.AndPredicate.ANY_AND);
      }

      public static BredSrechEntityTrigger.Instance forParent(EntityPredicate.Builder builder) {
         return new BredSrechEntityTrigger.Instance(EntityPredicate.AndPredicate.ANY_AND, EntityPredicate.AndPredicate.ANY_AND, EntityPredicate.AndPredicate.ANY_AND, EntityPredicate.AndPredicate.createAndFromEntityCondition(builder.build()));
      }

      public static BredSrechEntityTrigger.Instance forAll(EntityPredicate parent, EntityPredicate partner, EntityPredicate child) {
         return new BredSrechEntityTrigger.Instance(EntityPredicate.AndPredicate.ANY_AND, EntityPredicate.AndPredicate.createAndFromEntityCondition(parent), EntityPredicate.AndPredicate.createAndFromEntityCondition(partner), EntityPredicate.AndPredicate.createAndFromEntityCondition(child));
      }
