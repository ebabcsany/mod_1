...
public class SrechEntityBreedGoal extends Goal {
   ...
   protected final AbstractSrechEntity animal;
   private final Class<? extends AbstractSrechEntity> mateClass;
   protected final World world;
   protected AbstractSrechEntity targetMate;
   private int spawnBabyDelay;
   private final double moveSpeed;

   public SrechEntityBreedGoal(AbstractSrechEntity animal, double speedIn) {
      this(animal, speedIn, animal.getClass());
   }

   public SrechEntityBreedGoal(AbstractSrechEntity animal, double moveSpeed, Class<? extends AbstractSrechEntity> mateClass) {
      this.animal = animal;
    ...
    */
   @Nullable
   private AbstractSrechEntity getNearbyMate() {
      List<AbstractSrechEntity> list = this.world.getTargettableEntitiesWithinAABB(this.mateClass, field_220689_d, this.animal, this.animal.getBoundingBox().grow(8.0D));
