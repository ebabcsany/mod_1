...
public class KnurthTorch extends Block {
   protected static final VoxelShape SHAPE = Block.makeCuboidShape(6.0D, 0.0D, 6.0D, 10.0D, 10.0D, 10.0D);
   protected final IParticleData field_235607_e_;

   public KnurthTorch(Properties properties, IParticleData particleData) {
      super(properties);
      this.field_235607_e_ = particleData;
   }
